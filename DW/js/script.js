 ...
 * @Last Modified time: 2018-12-27 16:38:58
 */
(function () {
...
})(); var c = document.getElementById("V_Canvas"), ctx = c.getContext("2d"); ctx.font = "30px '微软雅黑"; var gradient = ctx.createLinearGradient(0, 0, c.width, 0); gradient.addColorStop("0", "#337ab7"); gradient.addColorStop("0.5", "#303030"); gradient.addColorStop("1.0", "#337ab7"); ctx.fillStyle = gradient; ctx.fillText("\u5b9e/\u6218/\u63a8/\u8350", 20, 40);
