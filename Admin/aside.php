<aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
    ...
    <ul class="nav nav-sidebar">
        <li <?php echo $php_self == "article.php" || $php_self == "addArticle.php" ? "class='active'" : ""; ?>><a href="article">文章</a></li>
    ...
    <ul class="nav nav-sidebar">
        ...
        <li <?php echo $php_self == "fLink.php" || $php_self == "add-fLink.php" ? "class='active'" : ""; ?>><a href="fLink">友链</a></li>
    </ul>
    <ul class="nav nav-sidebar">
