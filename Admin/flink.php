            ...
            <nav>
              ...
              <ul class="pagination pagenav quotes">
                <li <?php echo $page == 1 ? "class=\"disabled\"" : "class=\"canClick\"" ?>>
                  <a href="/Admin/fLink.php?page=1" aria-label="Previous">
                    &laquo;
                  </a>
                </li>
                <?php
                for ($i = 0; $i < $page_num; $i++) {
                  ...
                  <li <?php echo $page == (1 + $i) ? "class=\"active\"" : "class=\"canClick\"" ?>>
                    <a href="/Admin/fLink.php?page=<?php echo (1 + $i) ?>">
                      <?php echo (1 + $i) ?>
                    </a>
                  </li>
                <?php
              ...
              ?>
                <li <?php echo $page == $page_num ? "class=\"disabled\"" : "class=\"canClick\"" ?>>
                  <a href="/Admin/fLink.php?page=<?php echo $page_num ?>" aria-label="Next">
                    &raquo;
                  </a>
                </li>
              </ul>
            ...
            $.ajax({
              ...
              success: function(data) {
                if (data == "true") {
                  ...
                  CanClick("/Admin/fLink.php?page=<?php echo $page ?>");
                }
              }
            });
          };
            ...
            success: function(data) {
              if (data == "true") {
                if (arr.length == <?php echo $result->num_rows ?>) {
                  CanClick("/Admin/fLink.php?page=<?php echo $page - 1 ?>");
                } else {
                  CanClick("/Admin/fLink.php?page=<?php echo $page ?>");
                }
                iziToast.success({
